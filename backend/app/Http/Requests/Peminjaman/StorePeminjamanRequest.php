...
class StorePeminjamanRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'items.*.alat_id.required' => 'ID alat wajib diisi untuk setiap item.',
            'items.*.jumlah.required' => 'Jumlah alat wajib diisi untuk setiap item.',
        ];
    }

    // Menambahkan atribut khusus untuk pesan validasi
